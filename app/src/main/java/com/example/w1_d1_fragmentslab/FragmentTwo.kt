...
class FragmentTwo : Fragment(R.layout.fragment_two) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.PresidentStartdate).text = president.start.toString()
        view.findViewById<TextView>(R.id.PresidentEnddate).text = president.end.toString()
    }
